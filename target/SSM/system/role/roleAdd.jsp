	...
	<section class="container">
	    <div class="row">
            <ul class="breadcrumbs-alt">
                ...
                <li><a href="#">系统管理</a></li>
                <li><a href="#">角色管理</a></li>
                <li><a href="#" class="current">新增角色</a></li>
            </ul>
	    </div>
	            ...
	            <table class="table">
	                ...
	                <tbody>
	                    <tr>
	                        ...
	                        <td>
	                        	<div class="col-sm-3">
	                        		<input type="text" name="roleid"  value="${roleid}" readOnly="true" class="form-control round-input"/>
	                        	</div>
	                        </td>
	                    </tr>
	                    <tr>
	                        ...
	                        <td>
	                        	<div class="col-sm-3">
	                        		<input type="text" name="rolename"  maxlength="20" class="form-control round-input"
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <div class="col-sm-6">
	                                <textarea name="roledesc"  class="form-control" rows="3" maxchar="64"></textarea>
	                            </div>
	                        </td>
	                    </tr>
		                                    		...
		                                    		<td>
		                                    			<c:forEach var="function" items="${functionList}" varStatus="status">
		                                    				<c:if test="${function.groupid == fgroup.groupid}">
		                                    					<input  name="fidList" type="checkbox" value="${function.functionid}">${function.functionname}
		                                    				</c:if>
		                                    			</c:forEach>
		                                    		</td>
		                                    	</tr>
