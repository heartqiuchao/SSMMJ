			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					...
					<li><a href="about.jsp">新闻天地</a></li>
					<li><a href="gallery.jsp">生活风采</a></li>
					<li class="dropdown">
					  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">中心概况<span class="caret"></span></a>
					  <ul class="dropdown-menu">
						<li><a href="codes.jsp">团队建设</a></li>
						<li><a href="icons.jsp">科研项目</a></li>
					  </ul>
					</li>
