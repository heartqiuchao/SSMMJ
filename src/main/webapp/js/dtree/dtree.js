...
dTree.prototype.toString = function() {
	var str = '<div class="dtree" style="white-space:nowrap;">\n';
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
		str += '<a target="innerFrame" id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" href="' + node.url + '"';
